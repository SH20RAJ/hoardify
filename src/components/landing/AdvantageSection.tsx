		...
		<section className="py-20 md:py-32 bg-white">
			<div className="container mx-auto px-4 sm:px-6 max-w-7xl">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
					<div className="group p-6 sm:p-8 md:p-12 rounded-[2rem] sm:rounded-[2.5rem] bg-surface-sunken border border-border-subtle hover:bg-white hover:shadow-premium-xl transition-all duration-700">
					...
					<div className="group p-6 sm:p-8 md:p-12 rounded-[2rem] sm:rounded-[2.5rem] bg-brand text-white shadow-premium-lg hover:shadow-premium-xl transition-all duration-700 hover:-translate-y-2">
						<div className="flex items-center gap-4 mb-10">
